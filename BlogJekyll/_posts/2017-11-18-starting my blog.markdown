...
---
<p>
	I would like to start my blog with a post on how I set up this blog. 
<p>
<p>
...
<p>
	Github pages promote Jekyll as a tool to build static websites. It's not officially supported from windows but so for installing it and running it on my Windows 10 (2017 Fall Creators Update) has worked out fine so far.
...
<p>
	After the reboot, start the Ubuntu terminal app again as an administrator. It will now show the screen below:<br/>
...
<p>
From the C:\ directory you can just use the "dir" and "cd" commands to navigate to the appropriate folder the same way you would in a Windows command prompt. To create a new Jekyll website within your current folder use the command below. (note that you do not need to use the sudo keyword anymore.)
{% highlight shell %}
jekyll new .
{%endhighlight%}
</p>
<p>
After it has finished you have a working default website that you can run with the command below.
{% highlight shell %}
jekyll serve
{%endhighlight%}
</p>
...
<ul>
	...
	<li>
	<a href="https://gist.github.com/smutnyleszek/9803727" target="_blank">Liquid for Github pages cheatsheet</a> 
	</li>
</ul>
</p>
<p>
After customizing your site template you can just worry about creating content pages. Any changes you make to your template at a later time will be reflected in all pages on the site. When uploading changes to your site repository, it may take a minute or so before changes are reflected in the browser.
